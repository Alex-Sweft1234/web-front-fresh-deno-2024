...
export function Modal({ children, isOpen = false, onClose = () => {} }: IModal) {
  ...
  return (
    <div data-dialog-backdrop="dialog-sm" data-dialog-backdrop-close="false" className="pointer-events-none fixed inset-0 z-[999] grid h-screen w-screen place-items-center bg-black bg-opacity-60 opacity-0 backdrop-blur-sm transition-opacity duration-300">
